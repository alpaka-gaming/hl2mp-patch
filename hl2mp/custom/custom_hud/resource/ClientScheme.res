Scheme
{
	...
	BaseSettings
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////
		// Health
		Color_HealthIcon_Fg              "255 220 0 100"
		Color_Health_Fg                  "255 220 0 100"
		Color_Health_Bg                  "0 0 0 76"
		Color_HealthIcon_Fg_Increased    "255 220 0 255"
		Color_Health_Fg_Increased        "255 220 0 255"
		Color_Health_Bg_Increased        "0 0 0 76"
		Color_HealthIcon_Fg_DamageTaken  "255 220 0 255"
		Color_Health_Fg_DamageTaken      "255 220 0 255"
		Color_Health_Bg_DamageTaken      "180 0 0 200"
		Color_HealthIcon_Fg_Pulse        "180 0 0 255"
		Color_Health_Fg_Pulse            "180 0 0 255"
		Color_Health_Bg_Pulse            "100 0 0 80"

		// SuitPower (Armor)
		Color_SuitPowerIcon_Fg              "255 220 0 100"
		Color_SuitPower_Fg                  "255 220 0 100"
		Color_SuitPower_Bg                  "0 0 0 76"
		Color_SuitPowerIcon_Fg_Increased    "255 220 0 255"
		Color_SuitPower_Fg_Increased        "255 220 0 255"
		Color_SuitPower_Bg_Increased        "0 0 0 76"
		Color_SuitPowerIcon_Fg_DamageTaken  "255 220 0 255"
		Color_SuitPower_Fg_DamageTaken      "255 220 0 255"
		Color_SuitPower_Bg_DamageTaken      "180 0 0 200"
		Color_SuitPowerIcon_Fg_Empty        "255 220 0 0"
		Color_SuitPower_Fg_Empty            "255 220 0 0"
		Color_SuitPower_Bg_Empty            "0 0 0 0"

		// SuitAuxPower
		Color_HudAuxPower_Fg_100      "255 220 0 100"
		Color_HudAuxPower_Bg_100      "0 0 0 76"
		Color_HudAuxPower_Fg_Not100   "255 220 0 220"
		Color_HudAuxPower_Bg_Not100   "0 0 0 76"
		Color_HudAuxPower_Fg_Below25  "255 0 0 220"
		Color_HudAuxPower_Bg_Below25  "0 0 0 76"
		Color_HudAuxPower_Fg_Above25  "255 220 0 220"
		Color_HudAuxPower_Bg_Above25  "0 0 0 76"

		// Ammo (no colors for ammo2, it doesn't work)
		Color_Ammo_Fg               "255 220 0 100"
		Color_Ammo_Bg               "0 0 0 76"
		Color_Ammo_Fg_Increased     "255 220 0 255"
		Color_Ammo_Bg_Increased     "0 0 0 76"
		Color_Ammo_Fg_Decreased     "255 220 0 255"
		Color_Ammo_Bg_Decreased     "0 0 0 76"
		Color_Ammo_Fg_Empty         "180 0 0 200"
		Color_Ammo_Bg_Empty         "0 0 0 76"
		Color_AmmoSec_Fg_Increased  "255 220 0 255"
		Color_AmmoSec_Bg_Increased  "0 0 0 76"
		Color_AmmoSec_Fg_Decreased  "255 220 0 255"
		Color_AmmoSec_Bg_Decreased  "0 0 0 76"
		Color_AmmoSec_Fg_Empty      "180 0 0 200"
		Color_AmmoSec_Bg_Empty      "0 0 0 76"

		// Weapon Slots
		Color_WpnIcon              "255 220 0 100"
		Color_WpnIconSelected      "255 220 0 100"
		Color_WpnBoxPanel          "0 0 0 80"
		Color_WpnBoxPanelSelected  "0 0 0 80"
		Color_WpnBoxPanelEmpty     "0 0 0 80"
		Color_WpnBoxNumbers        "255 220 0 255"
		Color_WpnName              "255 220 0 255"

		// Damage
		Color_DamageIndicators            "255 0 0 200"
		Color_DamageIndicators_ZeroAlpha  "255 0 0 0"
		Color_DamageScreenFill            "255 0 0 200"
	...
	CustomFontFiles
	{
		...
		"0"  "resource/fonts/HPH_Nmb_Default.ttf"
